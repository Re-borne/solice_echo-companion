...
PAGES=("index" "speak_time" "image_reader""voice_capture_knowledge"
"voice_capture_knowledge_backups" "barcode_scanner" "tell_joke" "take_note" "wisdom" "set_alarm" "set_reminder" "read_message" "library")
